...
class BikeRentalSystem {
    ...
    public void menu() {
        ...
        double exchangeRate = 82.0; // Example exchange rate: 1 USD = 82 INR
        ...
        while (true) {
            ...
            if (choice == 1) {
                ...
                if (selectedBike != null) {
                    double totalPriceUSD = selectedBike.calculatePrice(rentalDays);
                    double totalPriceINR = totalPriceUSD * exchangeRate;
                    ...
                    System.out.printf("Total Price: $%.2f (USD)%n", totalPriceUSD);
                    System.out.printf("Total Price: ₹%.2f (INR)%n", totalPriceINR);
...
public class Project{
    public static void main(String[] args) {
        ...
        Bike bike1 = new Bike("B001", "Yamaha", "FZ", 30.0); // Different base price per day for each bike
        Bike bike2 = new Bike("B002", "Honda", "CBR", 50.0);
        Bike bike3 = new Bike("B003", "Royal Enfield", "Bullet", 100.0);
